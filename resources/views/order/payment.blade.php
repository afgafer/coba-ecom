		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
            <a href="{{ url('/') }}">Home</a>
            <a href="{{ route('customer.index_order') }}">Konfirmasi Pembayaran</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="card-body">
                    <form action="{{ route('customer.payment') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="date" id="transfer_date" class="form-control" required>
